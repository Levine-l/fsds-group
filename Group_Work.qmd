...
Listings operating for more than 90 days also tend to have higher prices than compliant listings. This pricing pattern is consistent with the argument of @barron_effect_2021 that Airbnb expansion facilitates a shift of housing from the long-term to the short-term rental market, placing upward pressure on rents and property values.

**Conclusion**

Taken together, high levels of availability beyond the 90-day limit, consistent patterns across property types, and pricing signals associated with commercial use suggest that Airbnb activity in London exhibits characteristics of being “out of control.” 
...
The analysis assumes that strong spatial clustering of Airbnb listings in London, particularly in areas with high prices and a high share of long-availability properties, reflects commercialised short-term rental activity rather than casual home-sharing. Spatial concentration is therefore treated as an indicator of potential regulatory pressure in the London housing market.
...
The results show that Airbnb listings in London are highly concentrated in central London, rather than evenly distributed across the city. These hotspots coincide with high-value areas and intensive use. It suggests that regulatory challenges are spatially uneven across London and may be more effectively addressed through targeted, area-specific interventions.
...
cluster_labels = {
    0: "High Airbnb activity areas",
    1: "Moderate Airbnb activity areas",
    2: "Low Airbnb activity areas"
}
...
```
This shows a highly uneven distribution of Airbnb listings across hosts in London. A substantial share of activity is concentrated among hosts controlling multiple properties. 

The professional landlords， who own more than 2 properties, account for approximately 35% of all hosts, yet they control around 65% of total Airbnb listings. This disparity indicates that a relatively small group of actors exerts disproportionate influence over the short-term rental market. The cumulative distribution further highlights that as host portfolio size increases, control over listings rises rapidly, particularly among hosts owning five or more properties.
...
ax.set_title("Proportion of Listings in each area Affected by the Proposal")
ax.set_axis_off()
plt.show()
```
...
For the Mayor, a regulatory focus on professional short-term rental operators offers strong political and strategic credibility. This approach links policy directly to spatial and structural evidence, allowing for differentiated measures and enabling more moderately equitable problem-solving. By distinguishing casual home-sharing from business-oriented short-term rentals, housing pressures can be addressed without penalising ordinary residents, consistent with urban planning best practice (@gurran_when_2017). This approach also supports targeted fiscal measures, such as higher Council Tax rates or levies on commercial rentals, which can be justified as internalising external costs in high-impact areas. 

The main risk lies in resistance from professional landlords, who may lobby or pursue legal challenges (@barron_effect_2021).Clear communication is essential: the Mayor must present the proposal as an independent, data-driven response to uneven housing pressures, not a reactive or symbolic intervention.

### 4.2 Implication for Residents 

For residents, particularly in central boroughs, regulation may improve housing availability and neighbourhood stability. As shown in Question 3, many professional Airbnb listings operate on a near full-time basis, reducing long-term rental supply. Regulating this segment may encourage some properties to return to the long-term market, easing pressure in the most affected areas, even if city-wide rent reductions remain limited (@garcia-lopez_short-term_2020). Reduced clustering may also improve quality of life by lowering noise, turnover, and social disruption (@gurran_when_2017). 

Nevertheless, Airbnb provides flexible accommodation for students, temporary workers, and households in transition. Tighter regulation may reduce these options in central locations, potentially shifting demand toward hotels or serviced apartments and increasing costs for middle-income users. As a result, the benefits of regulation are likely to be unevenly distributed across the city.

### 4.3 Implication for City

At the city scale, targeted regulation may improve housing market efficiency by limiting the conversion of residential properties into commercial short-term rentals in high-pressure areas. Enhanced registration and monitoring can strengthen governance capacity and support more adaptive policy responses. 

However, displacement effects remain a risk, as activity may shift to other boroughs or platforms rather than disappear (@garcia-lopez_short-term_2020). Given the uneven spatial distribution of Airbnb impacts, uniform city-wide regulation may be inefficient, highlighting the need for spatially differentiated enforcement.
