...
The results show a clear alignment between spatial concentration and professionalisation. Boroughs with the highest number of listings also exhibit the highest multi-lister shares. Westminster records the largest number of listings (8,347) and the highest multi-lister share (84%), followed by Kensington and Chelsea (80%) and Camden (77%). This indicates that Airbnb activity in London’s core areas is dominated by professional operators managing multiple units, rather than individual residents renting occasionally.
...
This pattern indicates that Airbnb activity in Westminster is not only borough-level concentrated but also intensely localised within a small number of MSOAs. These super-dense zones are likely to function more like informal hotel districts than home-sharing areas, reinforcing evidence that Airbnb activity in London is “out of control” in specific high-pressure locations. This finding is consistent with prior research linking Airbnb misuse to tourism-intensive, high-value neighbourhoods (@shabrina_airbnb_2022).
...
### 1.8 Limitation
There are several limitations in our analysis. First, Availability_365 does not directly measure occupancy and may overestimate non-compliance where hosts block calendars for non-rental reasons. Second, high prices may reflect location or property quality rather than professional management. Third, using boroughs and MSOAs as spatial units may hide variation within neighbourhoods or individual buildings. Finally, defining professional hosts as those with more than two listings is conservative and likely underestimates commercialisation. Which means, the results showing overall patterns rather than precise measurements of regulatory non-compliance.
